	...
	var uploader = {
		...
		'setOptions' : function(page,id){
			...
			if ($this.options.multiple) {
				fileNumLimit = isNaN(Number($this.options.fileNumLimit)) ? 30 : Number($this.options.fileNumLimit);
			}else{
				fileNumLimit = 1;
			}
			if($this.options.isWechat){
				...
				fileSingleImageSizeLimit = isNaN(Number($this.options.fileSingleImageSizeLimit)) ? 5 * 1024 * 1024 : Number($this.options.fileSingleImageSizeLimit);
				fileSingleVoiceSizeLimit = isNaN(Number($this.options.fileSingleVoiceSizeLimit)) ? 5 * 1024 * 1024 : Number($this.options.fileSingleVoiceSizeLimit);
				fileSingleVideoSizeLimit = isNaN(Number($this.options.fileSingleVideoSizeLimit)) ? 5 * 1024 * 1024 : Number($this.options.fileSingleVideoSizeLimit);
			}
