(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		// AMD
		define(['jquery', 'underscore', 'webuploader', 'jquery.jplayer', 'bootstrap', 'filestyle'], function ($, _, WebUploader) {
			return (root['fileUploader'] = factory($, _, WebUploader));
		});
	} else if (typeof module === 'object' && typeof module.exports === 'object') {
		// commonJS
		module.exports = factory(require("jquery"),require("underscore"),require("webuploader"),require("jquery.jplayer"),require("bootstrap"),require("filestyle"));
	} else {
