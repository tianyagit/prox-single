...
`type` tinyint(2) NOT NULL COMMENT '1、概况趋势；2、访问日趋势；3、访问周趋势；4、访问月趋势；5、访问分布；6、访问日留存；7、周留存；8、访问月留存；9、访问页面' ,
`stay_time_uv` decimal(5,4) NOT NULL COMMENT '人均停留时长' ,
`stay_time_session` decimal(5,4) NOT NULL COMMENT '次均停留时长' ,
`visit_depth` decimal(5,4) NOT NULL COMMENT '平均访问深度' ,
